<template>
  <div class="content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen" :class="theme">
    <header class="border-t-14 border-gray-700">
    ...
    <footer class="bg-gray-700 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        <div class="mb-8 lg:mb-0">
          ...
          <div>
            Website design by <a href="https://github.com/drehimself/gridsome-portfolio-starter" class="text-white hover:text-gray-400 font-normal">Andre Madarang</a>.
          </div>
        </div>
        <ul class="flex items-center space-x-8">
          <li>
            <a href="https://github.com/augusthur" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://twitter.com/augusthur" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://instagram.com/gus.thur" target="_blank" class="text-white hover:text-gray-400">
